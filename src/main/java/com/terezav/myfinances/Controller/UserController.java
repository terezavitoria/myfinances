...
import com.terezav.myfinances.service.UserService;
...
public class UserController {
	...
	@ApiResponses({ 
		...
		@ApiResponse(responseCode = "500", description = "Erro interno no servidor - myfinances.service.user.notfound.exception") })
	@GetMapping("/{id}")
